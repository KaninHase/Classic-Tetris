...
public class Mino {
    ...
    public int direction = 1; // There are 4 diferent directions (1/2/3/4)
    ...
    private void deactivating() {
        ...
        if (deactivateCounter == 45) {
            ...
            // if the bottom is still hitting after 45 frames , deactivate Mino
            if (bottomCollision) {
                active = false;
            }
        }
